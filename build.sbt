...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    homepage := Some(url("https://http4s.github.io/http4s-jdk-http-client")),
    licenses := List("Apache-2.0" -> url("https://http4s.github.io/http4s-jdk-http-client/license.html")),
